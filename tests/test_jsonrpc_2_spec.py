...
def testNonExistingMethod(jsonrpc_fetch):
    ...
    # json_rpc uses a more detailed response and therefore this isn't
...
def testBatchCallWithInvalidRequests(jsonrpc_fetch):
    ...
    for json_response in json_responses:
        ...
        # json_rpc uses a more detailed response and therefore this
        ...
        for expected_response in expected_responses:
            if json_response['id'] == expected_response['id']:
                ...
                if 'error' in json_response:
                    # json_rpc uses a more detailed response and
